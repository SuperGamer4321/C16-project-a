...
function preload(){
  ...
  gameOSnd = loadSound("90006227.mp3");
  knifeSnd = loadSound("Super-Short-Transition-Whoosh-A-www.fesliyanstudios.com.mp3");
}
...
function draw() {
  ...
  if(gameState===PLAY){
   textSize(25);
   fill("black");
    text("Click any where to play",330,580);
